...
const BASE_CLASS =
  "taskbar-start-button inline-flex items-center justify-center rounded-sm p-2 text-[var(--taskbar-foreground)] hover:bg-[var(--taskbar-surface-hover)] active:bg-[var(--taskbar-surface-active)] focus-visible:taskbar-focus-ring transition-colors duration-150";
